...
--
ALTER TABLE `category`
  ADD CONSTRAINT `userkey` FOREIGN KEY (`creator`) REFERENCES `user` (`id`);

--
-- 限制表 `coupon`
--
ALTER TABLE `coupon`
  ADD CONSTRAINT `products_id1213` FOREIGN KEY (`product_id`) REFERENCES `product` (`id_product`),
  ADD CONSTRAINT `user_id2113` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- 限制表 `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `coupons_id1323` FOREIGN KEY (`coupon`) REFERENCES `coupon` (`id`),
  ADD CONSTRAINT `products_id1323` FOREIGN KEY (`product_id`) REFERENCES `product` (`id_product`),
  ADD CONSTRAINT `user_id2133` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- 限制表 `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `categories_` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);

--
-- 限制表 `user_address`
--
ALTER TABLE `user_address`
  ADD CONSTRAINT `user_id213` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- 限制表 `user_product`
--
ALTER TABLE `user_product`
  ADD CONSTRAINT `products_id13233` FOREIGN KEY (`product_id`) REFERENCES `product` (`id_product`),
  ADD CONSTRAINT `user_id21333` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
