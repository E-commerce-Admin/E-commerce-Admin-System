...
if ($_POST) {
    ...
    if (!empty($error_messages)) {
        ...
        $query = mysqli_query($conn, "INSERT INTO coupon (product_name, coupon_name, discount, is_valid, is_delete, create_time, deadline, id_creator) VALUES ('" . $product_name . "', '" . $coupon_name . "', '" . $discount . "', 1, 0, CURRENT_TIMESTAMP(), '" . $deadline . "', '".$_SESSION['id_user']."')");
        if ($query) {
