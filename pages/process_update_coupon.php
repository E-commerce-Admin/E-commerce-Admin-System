...
if ($_POST) {
    ...
    if (!empty($error_messages)) {
        ...
        $query = mysqli_query($conn, "UPDATE coupon SET coupon_name='" . $coupon_name . "', product_name='" . $product_name . "', discount='" . $discount . "', is_valid='" . $validity . "', deadline='" . $deadline . "' WHERE id_coupon='" . $id_coupon . "'");
        if ($query) {
