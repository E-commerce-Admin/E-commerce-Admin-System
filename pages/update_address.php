          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <form method="POST" action="../pages/process_update_address.php" enctype="multipart/form-data">
                <section class="base">
                  <div class="mb-3">
                    <input type="hidden" name="id_user_address" value="<?= $dt_customer['id_user_address'] ?>">
                  </div>
                  <div class="mb-3">
                    <label for="customer_name" class="form-label">Customer Name</label>
                    <input type="text" name="customer_name" value="<?= $dt_customer['customer_name'] ?>"
                      class="form-control">
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Shipping Address</label>
                    <input type="text" name="shipping_address" value="<?= $dt_customer['shipping_address'] ?>"
                      class="form-control">
                  </div>
                  <div>
                    <input type="submit" name="simpan" value="Update Address" class="btn btn-primary">
                    <a class="btn btn-warning" href="../pages/address.php">Cancel</a>
                  </div>
                </section>
              </form>
