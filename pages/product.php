            ...
            <div class="card-header pb-0">
              ...
              if ($result) {
                ...
                if ($authority_level == 2) {
                  echo '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Product</button>';
                } else {
                  echo '<button type="button" class="btn btn-primary" onclick="alert(\'You do not have the authority to perform this action. Please log in with a super admin account.\');">Add Product</button>';
                }
              } else {
                        ...
                        <td class="text-xs font-weight-bold">
                          ...
                          if ($result) {
                            ...
                            if ($authority_level == 2) {
                              ...
                              echo '<a class="btn btn-success" href="update_product.php?id_product=' . $data_product['id_product'] . '">Update</a>';
                              echo '<a href="delete_product.php?id_product=' . $data_product['id_product'] . '" onclick="return confirm(' . "'Are you sure you want to delete this data?'" . ')" class="btn btn-danger">Delete</a>';
                            } else {
