...
if ($_POST) {
    ...
    if (empty($id_address_customer)) {
        ...
        if ($customer != null) {
            ...
            $insert = mysqli_query($conn, "INSERT INTO user_address (id_customer, customer_name, shipping_address) 
            VALUES ('" . $id_customer . "', '" . $customer_name . "', '" . $shipping_address . "')") or die(mysqli_error($conn));
