              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $qry_order = mysqli_query($conn, "SELECT `order`.id_order, `order`.order_date, product.name_product AS product_name, product.product_photo, `order`.product_id, product.price, `order`.quantity, `order`.subtotal
                                  FROM `order`
